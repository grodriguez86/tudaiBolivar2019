...
$(document).ready(function() {
    ...
    function register(){
        let terminos = document.querySelector('.terminosCheck');
        ...
        if(terminos.checked) {
            ...
            btn.disabled = false;
            divContainer.innerHTML = '<div class="pl-3 pr-3 col-md-12"><div class="alert alert-danger" role="alert">No aceptó los términos y condiciones</div></div>';
        }
    }
});
